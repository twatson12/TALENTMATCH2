...
const DisplayRating = () => {
        ...
        const fetchTalents = async () => {
            try {
                ...
                const talentsData = talentsSnapshot.docs
                    ...
                    .filter((talent) => talent.RoleName === 'Talent'); // Filter only talents
    ...
    return (
        <div className="reviews-rating-container">
            ...
            <p>These reviews were done by active Entertainers! Get the inside scoop on all our Talents!</p>
                    ...
                    <div className="reviews-list">
                        {reviews.map((review, index) => (
                            <div key={index} className="review-item">
                                ...
                                <p><em>By: {review.EntertainerEmail}</em></p>
                            </div>
                        ))}
                    </div>
                </>
